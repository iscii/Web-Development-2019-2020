...
function dPaymentMethod(){
    ...
    if(x <= 4){
        ...
        totalCashSales = roundDecimal(totalElecSales, 2);
...
function manageData(){ //enhancement 2
    ...
    for(i = 0; i < FOODTYPES.length; i++){
        for(x = 0; x < eval(FOODTYPES[i]).length; x++){
            ...
            //itemCost = eval(avgTotalTypes[i])[x].split(";")[1];
    ...
    */
    ...
    //var logStructure = [avgItems, avgSales, avgCashSales, avgElecSales, avgRegBal];
