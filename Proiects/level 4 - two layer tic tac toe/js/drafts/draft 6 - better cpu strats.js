...
function randomize()
{
    ...
    {
        //YOU ARE HERE 1/6 FINISH THE THINGY AND REMOVE THE IF STATEMENT FOR ISPLAYABLE LAMO
    ...
    //always tries to take the middle grid
...
/*
function predictMove() //this function was added later -- I didn't plan this and implement it into my code, so it is redundant and out of place. I could've probably snuck it into somewhere in the checkForWin() function
{
